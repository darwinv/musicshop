...
<ul>
  <li class="interior-release-chart-content-item">
    <span class="category">
      {l s='Title' mod='roanjamusicshop'}</span><span class="value">{$associated_mp3.0.mp3_title}</span></li>
  <li class="interior-release-chart-content-item">
    <span class="category">
      {l s='Artists' mod='roanjamusicshop'}</span><span class="value">{$associated_mp3.0.author}</span></li>
  <li class="interior-release-chart-content-item">
    <span class="category">
      {l s='Genre' mod='roanjamusicshop'}</span><span class="value">{$associated_mp3.0.genero}</span></li>
  <li>
