...
public function updateMusic($id_music,$virtualproduct,$cancion=null,$autor=null,$genero=null){
$res=Db::getInstance()->update('rj_music_lang' , array(
    'mp3_title' =>pSQL($cancion),
    'author'  => pSQL($autor),
		'genero' => pSQL($genero),
		'linked_digital_id' => pSQL($virtualproduct)
		),
		"id_music= "."'$id_music'"
	);
	return $res;
	...
	public function isSong($idproduct){
